...
export default class AddRepository extends Command {
    ...
    static args = [{
        name: 'alias',
        required: false,
        description: 'alias of the template repository to retrieve, will look in official nitric repo store first if url is given this will be the name downloaded repository',
    }];
